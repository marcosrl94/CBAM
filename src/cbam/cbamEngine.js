...
// Sample portfolio fixtures live in `data/sampleClients.js` — re-exported
// here for backwards-compatible imports from older call sites.
export { SAMPLE_CLIENTS } from './data/sampleClients.js';
